const limit = 20; // limit is the number of products in each page
...
const displayProducts = async (page = 1) => {
  skip = (page -1) * limit; // to get the skip value which is the number of products that will be skipped
